...
class Telnet:
    ...
    def connect(self):
        try:
            ...
            raise ScrapycwTelnetException(e)
    ...
    def command(self, content: str = "", auto_change_type: bool = True):
        ...
        if self.__conn is None:
            raise ScrapycwTelnetNotConnectionException("Telnet don't connect, please connect it")
...
if __name__ == "__main__":
    try:
        ...
        print("连接被拒绝，该端口未被使用")
    except ScrapycwTelnetNotConnectionException as e:
        print("telnet未连接")
